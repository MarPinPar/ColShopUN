...
CREATE TABLE IF NOT EXISTS SESION_has_ACCION (
  ...
  `ACCION_ac_ID` INT,
  `ACCION_ac_fechaHora` DATETIME NOT NULL,
  PRIMARY KEY (`SESION_ses_fechaHoraIn`, `SESION_ses_fechaHoraOut`, `SESION_USUARIO_us_username`, `ACCION_ac_ID`, `ACCION_ac_fechaHora`),
  ...
  FOREIGN KEY (`ACCION_ac_ID` , `ACCION_ac_fechaHora`)
    REFERENCES ACCION (`ac_ID` , `ac_fechaHora`)
    );
...
CREATE TABLE IF NOT EXISTS BUSQUEDA (
  ...
  `ACCION_ac_ID` INT,
  `ACCION_ac_fechaHora` DATETIME NOT NULL,
  PRIMARY KEY (`ACCION_ac_ID`, `ACCION_ac_fechaHora`),
  FOREIGN KEY (`ACCION_ac_ID` , `ACCION_ac_fechaHora`) REFERENCES ACCION (`ac_ID` , `ac_fechaHora`)
);
...
CREATE TABLE IF NOT EXISTS BUSQUEDA_has_PRODUCTO (
  ...
  `BUSQUEDA_ACCION_ac_fechaHora` DATETIME NOT NULL,
  `PRODUCTO_pro_ID` INT NOT NULL,
  PRIMARY KEY (`BUSQUEDA_ACCION_ac_ID`, `BUSQUEDA_ACCION_ac_fechaHora`, `PRODUCTO_pro_ID`),
  FOREIGN KEY (`BUSQUEDA_ACCION_ac_ID` , `BUSQUEDA_ACCION_ac_fechaHora`) REFERENCES BUSQUEDA (`ACCION_ac_ID` , `ACCION_ac_fechaHora`),
  FOREIGN KEY (`PRODUCTO_pro_ID`) REFERENCES PRODUCTO (`pro_ID`)
);
...
CREATE TABLE IF NOT EXISTS COMPARACION_has_PRODUCTO (
  ...
  `COMPARACION_ACCION_ac_fechaHora` DATETIME NOT NULL,
  `PRODUCTO_pro_ID` INT NOT NULL,
  PRIMARY KEY (`COMPARACION_ACCION_ac_ID`, `COMPARACION_ACCION_ac_fechaHora`, `PRODUCTO_pro_ID`),
  FOREIGN KEY (`COMPARACION_ACCION_ac_ID` , `COMPARACION_ACCION_ac_fechaHora`) REFERENCES COMPARACION (`ACCION_ac_ID` , `ACCION_ac_fechaHora`),
  FOREIGN KEY (`PRODUCTO_pro_ID`) REFERENCES PRODUCTO (`pro_ID`)
  );
